...
const Home = () => {
  ...
  return (
    <div>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              ...
              <span className="sm:block">TrueDat </span>
            </h1>

            <p className="mx-auto mt-4 max-w-xl sm:text-xl/relaxed">
            Empowering you with accurate information using advanced AI technology. Verify facts from various sources instantly.
            </p>
      ...
      <section>
  <div data-aos="zoom-in" className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
...
<div data-aos="zoom-in" className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
<h1 className='font-bold text-black text-center text-[30px] mb-20'>PRICING</h1>
...
<footer data-aos="zoom-in" className="bg-gray-100">
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
      <li>
        <a className="text-gray-700 transition hover:text-gray-700/75" href="/audio"> Audio </a>
      </li>

      <li>
        <a className="text-gray-700 transition hover:text-gray-700/75" href="/video"> Video</a>
      </li>

      <li>
        <a className="text-gray-700 transition hover:text-gray-700/75" href="/image"> Image </a>
      </li>
